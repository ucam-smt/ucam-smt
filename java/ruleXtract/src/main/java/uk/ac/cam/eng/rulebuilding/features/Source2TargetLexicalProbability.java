 ...
 * @date 28 May 2014
 */
class Source2TargetLexicalProbability implements Feature {

	private final static String featureName = "source2target_lexical_probability";
	...
	public Map<Integer, Double> value(Rule r, FeatureMap mapReduceFeatures,
		...
		if (mapReduceFeatures.containsKey(mapreduceFeatureIndex)) {
			res.put(featureIndex, mapReduceFeatures.get(mapreduceFeatureIndex)
					.get());
		} else {
