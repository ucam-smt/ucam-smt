...
/**
 * This class represents the phrase insertion penalty feature, that is the
 * feature that counts the Double of rules used in translation
 * 
 * @author Juan Pino
 * @date 28 May 2014
 */
class RuleInsertionPenalty implements Feature {
