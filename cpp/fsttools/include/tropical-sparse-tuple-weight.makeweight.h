...
struct MakeSparseVectorWeight {
  ...
  inline TropicalSparseTupleWeight<float> operator() ( const typename Arc::Weight &w ) const {
...
struct MakeSparseVectorWeight<LexStdArc> {
  ...
  inline TropicalSparseTupleWeight<float> operator() ( const  LexStdArc::Weight & w ) const {
    TropicalSparseTupleWeight<float> result;
...
struct MakeWeight<TupleArc32> {
  ...
  inline TupleArc32::Weight operator ()  ( const TupleArc32::Weight &weight ) const  {return weight ;};
