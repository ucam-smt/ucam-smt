...
/**
 * \file
 * \brief Hifst client  main entry file.
 * \date 8-8-2012
 * \author Gonzalo Iglesias
 */

///Include all necessary headers here.
#include <main.hifst-client.hpp>
...
main ( int argc, const char *argv[] ) {
  ...
  FORCELINFO ( rg.dump ( "CONFIG parameters:\n====================="
                         , "=====================" ) );
  ( ucam::util::Runner2<ucam::hifst::SingleThreadedHifstClientTask<>
    , ucam::hifst::SingleThreadedHifstClientTask<> > ( rg ) ) ();
